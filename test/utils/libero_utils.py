...
def save_rollout_video(rollout_traj, idx, success, task_description, log_file=None, dataset_name="libero", run=0, change_command=False, command_level=None):
    ...
    if change_command and command_level:
        rollout_dir = f"/home/A.CARDAMONE7/outputs/rollouts/libero_goal/syntactic_variation/tinyvla/checkpoint_54000_{command_level}_variations_test/{command_level}/run_{run}"
    else:
        rollout_dir = f"/home/A.CARDAMONE7/outputs/rollouts/libero_goal/syntactic_variation/tinyvla/checkpoint_54000/default/run_{run}"
