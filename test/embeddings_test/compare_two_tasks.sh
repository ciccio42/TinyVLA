...
#SBATCH --job-name=compare_two_tasks_tinyvla
...
#SBATCH --mem=32G
#SBATCH --time=1:00:00
#SBATCH --output=/mnt/beegfs/a.cardamone7/outputs/logs/compare_two_tasks_tinyvla_l2_%j.out
#SBATCH --error=/mnt/beegfs/a.cardamone7/outputs/logs/compare_two_tasks_tinyvla_l2_%j.err
...
echo "=========================================="
echo "Compare Two Tasks - TinyVLA"
echo "=========================================="
...
TASK_A="open_the_top_drawer_and_put_the_bowl_inside"
LEVEL_A="l2"

TASK_B="push_the_plate_to_the_front_of_the_stove"
LEVEL_B="default"

# Decommentare per forzare la stessa scena visiva per entrambi i comandi:
SCENE_TASK="push_the_plate_to_the_front_of_the_stove"
