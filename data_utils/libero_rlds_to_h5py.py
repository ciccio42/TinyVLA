...
if __name__ == "__main__":
    ...
    for episode in tqdm(ds):
        ...
        for idx, step in enumerate(episode['steps']):
            ...
            cur_obs_gripper_pos.append(step['observation']['state'][-2:].numpy())
            cur_obs_joint_state.append(step['observation']['joint_state'].numpy())
            raw_lang = step['language_instruction'].numpy().decode('utf-8')
            cur_obs_cartesian_position.append(step['observation']['state'][:-2].numpy())
